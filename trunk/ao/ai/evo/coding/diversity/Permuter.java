 ...
 *
 */
public class Permuter<T> implements Enumeration<List<T>>
{
    //--------------------------------------------------------------------
     ...
     * @param toPermute ...
     */
    public Permuter(List<T> toPermute)
    {
        this(toPermute, toPermute.size());
    }
     ...
     * @param toPermute ...
     */
    public Permuter(List<T> toPermute, int m)
    {
        this.items = toPermute;
        this.n     = toPermute.size();
        this.m     = m;
    ...
    public List<T> nextElement()
    {
        ...
        List<T>  out = new ArrayList<T>(m);
        for (int i = 0; i < m; i++)
        {
            out.add( items.get(index[i]) );
        }
